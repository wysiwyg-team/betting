...
class Games
{
    ...
    public function fetchGames()
    {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo ucfirst($gameName) . "</h4><p class='card-text'><div>Game Price: <span class='gamePrice'>" . $this->gamePrice . "</span></div><div>Game Benefits: " . $gameBenefit . "%</div></p><a href='#' class='btn btn-primary' data-toggle='modal' data-target='#modal" . $this->gameID . "'>Place bet on game " . $this->gameID . "</a>";
            echo "</div></div></div>";
            ...
            echo '<div class="modal fade hideModal" id="modal' . $this->gameID . '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content"><div class="modal-header">
                     ...
                     <input type="hidden" id="gameId" name="gameId" value="'.$this->gameID.'">
                      <input type="hidden" id="gamePrice" name="gamePrice" value="'.$this->gamePrice.'">
                     ...
                     <div class="form-group"><label for="amount">Amount: </label>
                      ...
                      placeholder="Minimum bet is $' . $this->gamePrice . '">
